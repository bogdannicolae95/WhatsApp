                        ...
                        if(task.isSuccessful()){
                            ...
                            RootRef.child("Users").child(currentUserID).child("image").setValue(downloaedUrl).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(SettingsActivity.this,"Image save in database succesfully...",Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists() && (dataSnapshot.hasChild("name") && (dataSnapshot.hasChild("image")))){
                            ...
                            Toast.makeText(SettingsActivity.this,"Please set & update ypur profile information",Toast.LENGTH_SHORT).show();
                        }
                    }
