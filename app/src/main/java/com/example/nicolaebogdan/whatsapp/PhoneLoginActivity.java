...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputPhoneNumber = (EditText) findViewById(R.id.phone_number_imput);
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this,"Invalid Phone Number, Please enter correct phone number with ypur country code...",Toast.LENGTH_SHORT).show();
